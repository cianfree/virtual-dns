 ...
 */
public class Jdk9to11InetAddressDnsHook extends AbstractJdkInetAddressDnsHook {

    @Override
    protected Object createVirtualNameService() {
        return NameServiceUtil.createJdk9PlusNameServiceProxy(new DnsNameService(customDnsResolver));
    }
    ...
    protected Object createHookNameService(List<Object> nsList, NameServiceInterceptor interceptor) {
        return NameServiceUtil.createJdk9PlusNameServiceProxy(new NameServiceListWrapper(interceptor, nsList));
    }
}
